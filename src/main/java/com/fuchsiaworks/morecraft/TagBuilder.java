...
public class TagBuilder {
	public static enum TagType {
		VANILLA_BLOCK(JsonDataGenerator.DATA_VANILLA_TAGS_BLOCK_PATH), VANILLA_ITEM(
				JsonDataGenerator.DATA_VANILLA_TAGS_ITEM_PATH),

		BLOCK(JsonDataGenerator.DATA_TAGS_BLOCK_PATH), ITEM(JsonDataGenerator.DATA_TAGS_ITEM_PATH);
		...
		public static TagType[] BLOCK_ITEM = new TagType[] { BLOCK, ITEM };

		public static TagType[] VANILLA_BLOCK_ITEM = new TagType[] { VANILLA_BLOCK, VANILLA_ITEM };
	}
